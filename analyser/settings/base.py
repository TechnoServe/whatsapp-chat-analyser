...
if USE_S3 == "True":
    ...
    STATICFILES_DIR = (
        os.path.join("static"),
        os.path.join(BASE_DIR, "odk_dashboard/static"),
    )
...
SENTRY_DSN = (
    "https://9554a689d421479b96cb18b2b746e58c@o1001604.ingest.sentry.io/5961681"
)
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "../odk_dashboard/templates/jinja2"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
